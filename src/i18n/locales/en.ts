...
export const STRINGS_EN = {
  ...
  starfield: {
    ...
    edgeBrightness: 'Sidebar brightness', // Slider dimming the sidebars against the top (English: Sidebar brightness)
    edgeBrightnessDesc: 'Sidebars are dimmed against the top, so they stay in the background.', // Explains why they are dimmer (English: Sidebars are dimmed against the top, so they stay in the background.)
