...
// Build pipeline adapted from kepano's Minimal Theme Settings (MIT), including
// the dev loop that copies into the vault and reloads through the Obsidian CLI.
...
const PLUGIN_ID = "loop-skywalker-settings";
